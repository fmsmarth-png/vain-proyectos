...
export async function extraerPapeletaPdf(file: File): Promise<PapeletaPdf> {
  ...
  return {
    datos: extraerDatos(celdas),
    observaciones: extraerObservaciones(celdas),
  };
}
...
//  DATOS DE SOLICITUD
// ------------------------------------------------------------------
function extraerDatos(celdas: Celda[]): DatosSolicitud {
...
// ------------------------------------------------------------------
function extraerObservaciones(celdas: Celda[]): ObservacionPdf[] {
